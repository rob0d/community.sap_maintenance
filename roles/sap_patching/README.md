...
- `sap_patching_kernel_prepare_append_to_version`: To be used when not patching dw or SAPEXE e.g. when adding extra patch like R3trans to existing kernel patch (format `<kernel_version>p<patch_number>`). See  Append-to mode below.
